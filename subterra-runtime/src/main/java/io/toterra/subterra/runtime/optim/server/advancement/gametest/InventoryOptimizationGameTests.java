...
package io.toterra.subterra.runtime.optim.server.advancement.gametest;

import io.toterra.subterra.runtime.optim.server.advancement.InventoryAdvancementAccelerator;
import io.toterra.subterra.runtime.optim.server.advancement.index.InventorySnapshot;
...
// The structure namespace follows the Subterra mod id: the shared "empty"
// template lives at data/subterra/structure/empty.nbt in the shipped jar.
@GameTestHolder("subterra")
...
public final class InventoryOptimizationGameTests {
    ...
    private static CriterionTrigger.Listener<InventoryChangeTrigger.TriggerInstance> listener(
        ...
        AdvancementHolder holder = new AdvancementHolder(
                ResourceLocation.fromNamespaceAndPath(InventoryAdvancementAccelerator.MOD_ID, path), advancement);
