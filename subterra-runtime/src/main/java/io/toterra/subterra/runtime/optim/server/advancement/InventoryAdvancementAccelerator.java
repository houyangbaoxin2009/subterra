...
import io.toterra.subterra.runtime.optim.server.advancement.command.AdvancementCommand;
...
public final class InventoryAdvancementAccelerator {
    ...
    public static void bootstrap(ModContainer container) {
        ...
        container.registerConfig(ModConfig.Type.COMMON, AdvancementConfig.SPEC, "subterra-invadvopt-common.toml");
    ...
    public void onRegisterCommands(RegisterCommandsEvent event) {
        AdvancementCommand.register(event.getDispatcher());
    }
}
