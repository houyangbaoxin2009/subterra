...
/**
 * td (tie data) parser and writer — Java port of the subset implemented in
 * tie-main {@code config.parse_data} (header strip, optional table name, bare
 * tables). Supported values: strings (double-quoted with escapes), integers,
 * floats, booleans, nested tables and array elements. Separators are commas;
 * trailing commas are tolerated; {@code //} line comments are skipped.
 * <p>
