 ...
 * describes how the slot's {@link io.toterra.subterra.engine.worldgen.pipeline.density.Density}
 * field is computed:
 * <ul>
 ...
 *       (p.1.8.10, enters via {@link io.toterra.subterra.engine.worldgen.pipeline.dimension.DimensionSlot#with})</li>
 ...
 * {@link io.toterra.subterra.engine.worldgen.pipeline.density.Density} 场如何计算。
 */
public enum DimAlgo {
