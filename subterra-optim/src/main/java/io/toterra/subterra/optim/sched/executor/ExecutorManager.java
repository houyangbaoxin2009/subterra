...
// fastutil ReferenceArrayList (identity list) -> java.util.ArrayList. Only
// add / isEmpty / iteration are used and stored tasks are unique instances,
// so equals-vs-identity semantics are irrelevant here.
